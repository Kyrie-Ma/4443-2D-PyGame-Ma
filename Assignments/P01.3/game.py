...
img_path_L = ("baseball_48x48_left.png")
img_path_R = ("baseball_48x48_right.png")
img_path_U = ("baseball_48x48_upper.png")
img_path_D = ("baseball_48x48_down.png")
...
class Player:
    ...
    def move(self,camera_pos):
        ...
        if key[pygame.K_UP]: 
            ...
            self.image = pygame.image.load(img_path_U)
        if key[pygame.K_LEFT]:
            self.rect.x -= 10
            pos_x += 10
            self.image = pygame.image.load(img_path_L)
        if key[pygame.K_DOWN]:
            self.rect.y += 10
            pos_y -= 10
            self.image = pygame.image.load(img_path_D)
        if key[pygame.K_RIGHT]:
            self.rect.x += 10
            pos_x -= 10
            self.image = pygame.image.load(img_path_R)
